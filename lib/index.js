...
__export(src_exports, {
  ...
  FilePicker: () => file_picker_default,
...
var Fetcher = class {
  ...
  request(_0) {
    return __async(this, arguments, function* ({
      ...
      try {
        const response = yield fetchWithTimeout(url, requestOptions, timeout);
        if (this.logging) {
          logger_default(start, method, url, response, requestOptions);
        }
        if (response.ok) {
...
var FilePicker = class {
  ...
  static get(filePath) {
    return __async(this, null, function* () {
      try {
        const fileBuffer = yield import_fs.default.promises.readFile(filePath);
        const fileName = import_path.default.basename(filePath);
        const mimeType = import_mime_types.default.lookup(filePath);
        return new File([fileBuffer], fileName, {
          type: mimeType.toString()
...
var file_picker_default = FilePicker;
